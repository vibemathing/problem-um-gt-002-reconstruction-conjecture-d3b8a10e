...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-gt-002-reconstruction-conjecture-d3b8a10e-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GT-002"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-gt-002-reconstruction-conjecture-d3b8a10e-v1",
      "problem_contract_sha256": "834d6d646bff1cbf929f803be9736c869a2672040b69408c0c225e0bb4d3812a",
      "problem_id": "problem:um-gt-002-reconstruction-conjecture-d3b8a10e",
      "route_id": "route:um-gt-002-reconstruction-conjecture-d3b8a10e-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-gt-002-reconstruction-conjecture-d3b8a10e-source-fidelity-01",
      "graph_id": "graph:um-gt-002-reconstruction-conjecture-d3b8a10e-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-gt-002-reconstruction-conjecture-d3b8a10e-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-gt-002-reconstruction-conjecture-d3b8a10e-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Every finite simple graph on at least 3 vertices is uniquely determined by its vertex-deleted subgraphs."
          },
          "statement_sha256": "fcaeddc35c79157711148af4e39571981c35921976d27b7796d49f611f3bca0a"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-gt-002-reconstruction-conjecture-d3b8a10e-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-gt-002-reconstruction-conjecture-d3b8a10e-root",
      "route_id": "route:um-gt-002-reconstruction-conjecture-d3b8a10e-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-gt-002-2a9364caa1bf",
        "url": "https://www.unsolvedmath.com/problems/GT-002"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
